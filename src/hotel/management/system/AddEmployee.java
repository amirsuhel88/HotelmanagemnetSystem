...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfage,tfname,tfsalary,tfphone,tfemail,tfadhaar;
    ...
    AddEmployee(){
        ...
        rbfemale.setBounds(270,130,110,30);
        ...
        String str[] = {"Front Desk", "Porters", "House keeping", "kitchen staff", "Room Service", "Manager","Waiter/Waitress"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if((email.equals(""))||(!email.contains("@"))){
            JOptionPane.showMessageDialog(null, "Email can not be empty and must contain @");
            return;
        }
        ...
        try{
            Conn conn = new Conn();
            //name, age,gender,job,salary,phone,email,adhaar
